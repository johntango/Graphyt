...
flaw_b = [flaw_a[0]+0.0127*math.cos(theta*3.14159/180),flaw_a[1]+0.0127*math.sin(theta*3.14159/180),0.0]
flaw_c= [flaw_b[0],flaw_b[1]+cellsize+0.00127,0.0]
flaw_d = [flaw_a[0],flaw_a[1]+cellsize+0.00127,0.0]
...
for step in range(int(solver.tmax/solver.dt)):  # ; t<solver.tmax; t+=solver.dt):
    ...
    vtpfname='output/singleFlaw_rounded_30Deg_wRigid'+str(step)+'.vtp'
