...
R = 0.05
solid = pyck.Cylinder(1,[R+R+psep/2,R+R,R+R],R,[0,0,R])
topPlaten_lowerLeft = [R+R-0.50*cellsize,R+0.1,R+R]
topPlaten_upperRight = [R+R+1*cellsize,R+0.105,R+0.1] 
topPlaten = pyck.Cuboid(2,topPlaten_lowerLeft,topPlaten_upperRight)
bottomPlaten_lowerLeft = [R+R-0.50*cellsize,0.04,R+R]
bottomPlaten_upperRight = [R+R+1*cellsize,R,R+0.1] 
