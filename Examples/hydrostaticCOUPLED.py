...
rock.setBulkMod(10e6)
rock.setShearMod(2e6)
rock.setDensity(2000)
rock.setModel(1)
...
# /////////// Parameters Set /////////////// #
tmax = 0.50  # //(time in seconds)
is3D = False
parameters = graphyt.Parameters(tmax,is3D)
parameters.setGravity(0, -10, 0)
parameters.setCFL(0.01)
parameters.setDampingCoef(0.10)
...
for step in range(int(solver.tmax/solver.dt)):  # ; t<solver.tmax; t+=solver.dt):
    ...
    vtpfname='output/hydrostaticCOUPLED'+str(step)+'.vtp'
